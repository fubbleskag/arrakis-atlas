...
const BaseIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  ...
  >
    ...
    <g>
      <rect className="cls-2" x="5.19" y="5.19" width="21.63" height="21.63" transform="translate(-6.63 16) rotate(-45)"/>
      <path className="cls-1" d="M16,1.41l14.59,14.59-14.59,14.59L1.41,16,16,1.41M16,0L0,16l16,16,16-16L16,0h0Z"/>
    </g>
    ...
    <polygon className="cls-1" points="4.5 18.5 16 7 27.5 18.5 28.5 19.5 29.5 18.5 16 5 2.5 18.5 3.5 19.5 4.5 18.5"/>
  </svg>
);
